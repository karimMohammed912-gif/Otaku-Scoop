...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Name&&(identical(other.full, full) || other.full == full));
}
...
/// Create a copy of Name
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? full = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? full)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Name() when $default != null:
return $default(_that.full);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? full)  $default,) {final _that = this;
switch (_that) {
case _Name():
return $default(_that.full);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? full)?  $default,) {final _that = this;
switch (_that) {
case _Name() when $default != null:
return $default(_that.full);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Name&&(identical(other.full, full) || other.full == full));
}
...
/// Create a copy of Name
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? full = freezed,}) {
  return _then(_Name(
full: freezed == full ? _self.full : full // ignore: cast_nullable_to_non_nullable
as String?,
  ));
